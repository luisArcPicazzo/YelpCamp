...
mapboxgl.accessToken = mapBoxTokenFromEjsIndexTemplate;
    ...
    map.on('load', () => {
        ...
        map.on('click', 'unclustered-point', (e) => {
            const clusterMapPopUpText = e.features[0].properties.popUpMarkup; // can also destructure instead of defining a variable.
